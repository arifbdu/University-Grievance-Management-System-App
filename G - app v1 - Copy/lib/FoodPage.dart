...
class _FoodPageState extends State<FoodPage> {
  ...
  Future<void> submitFood(BuildContext context) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Food Grievance Submission Page'),
...
void main() {
  runApp(MaterialApp(
    home: FoodPage(apiUrl: 'http://192.168.43.192:8000/food/data/'),
  ));
}
