...
class CertificatePage extends StatefulWidget {
  ...
  CertificatePage({required this.apiUrl});
...
class _CertificatePageState extends State<CertificatePage> {
  ...
  Future<void> submitCertificate(BuildContext context) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Certificate Grievance Submission Page'),
...
void main() {
  runApp(MaterialApp(
    home: CertificatePage(apiUrl: 'http://192.168.43.192:8000/certificate/data/'),
  ));
}
