...
class AuthorityPage extends StatefulWidget {
  ...
  AuthorityPage({required this.apiUrl});
...
class _AuthorityPageState extends State<AuthorityPage> {
  ...
  Future<void> submitAuthority(BuildContext context) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Admin Grievance Submission Page'),
...
void main() {
  runApp(MaterialApp(
    home: AuthorityPage(apiUrl: 'http://192.168.43.192:8000/authority/data/'),
  ));
}
